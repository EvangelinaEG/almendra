...
public function listarPagos($idcliente){
	$sql="SELECT cc.idcccliente, cc.fechahorapago, cc.pago, u.nombre FROM cccliente cc INNER JOIN usuario u ON cc.idusuario = u.idusuario WHERE cc.idcliente ='$idcliente'";
	return ejecutarConsulta($sql);
}
