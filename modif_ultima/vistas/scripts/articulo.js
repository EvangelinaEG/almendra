 ...
 limpiar();
	$.post("../ajax/articulo.php?op=mostrar",{idarticulo : idarticulo},
		function(data,status)
		{
			...
			if(po3<=0){po3 = 0;}
			if(po4<=0){po4 = 0;}
			$("#por1").val(Math.round(po1));
			
			$("#por2").val(Math.round(po2));
			$("#por3").val(Math.round(po3));
			$("#por4").val(Math.round(po4));
