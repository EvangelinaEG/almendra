...
public function listar(){
	$sql="SELECT a.idarticulo,a.idcategoria, p.nombre as proveedor, c.nombre as categoria,a.codigo, a.nombre, a.stock, a.puntopedido , a.descripcion,a.precioventa1,  a.precioventa2,  a.precioventa3,  a.precioventa4, a.costo,a.condicion FROM articulo a LEFT JOIN persona p ON a.idproveedor = p.idpersona  INNER JOIN categoria c ON a.idcategoria=c.idcategoria";
	return ejecutarConsulta($sql);
}
...
public function filtrarVenta($valor){
	$sql="SELECT a.idarticulo,a.idcategoria,c.nombre as categoria,a.codigo, a.nombre, a.stock, a.puntopedido , a.descripcion,a.precioventa1,  a.precioventa2,  a.precioventa3,  a.precioventa4, a.costo, a.condicion FROM articulo a INNER JOIN categoria c ON a.idcategoria=c.idcategoria WHERE a.condicion = '1' AND a.stock > 0  AND a.nombre LIKE '%$valor%'  OR a.condicion = '1' AND a.codigo LIKE '%$valor%'";
	return ejecutarConsulta($sql);
}
