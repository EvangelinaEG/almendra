...
public function listarPagosf($idcliente){
...
public function listarPagos($idcliente,$fecha_inicio,$fecha_fin){
	$sql="SELECT cc.idcccliente, cc.fechahorapago, cc.pago, u.nombre, cc.factura, v.total_venta FROM cccliente cc  LEFT JOIN venta v ON cc.factura = v.idventa LEFT JOIN usuario u ON cc.idusuario = u.idusuario WHERE cc.idcliente ='$idcliente' AND DATE(cc.fechahorapago) >= '$fecha_inicio' AND DATE(cc.fechahorapago) <= '$fecha_fin'";
	return ejecutarConsulta($sql);
}
