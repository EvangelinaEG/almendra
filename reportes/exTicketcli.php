...
$rspta = $cccliente->ticketcabecera($_GET["id"], $_GET["fecha"]);

$reg=$rspta->fetch_object();

$rt = $cccliente->tickettotal($_GET["id"], $_GET["fecha"]);
...
<div class="zona_impresion">
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			...
			<td>Cliente: <h4 style="font-weight: bold; "><?php echo $reg->cliente; ?></h4>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				N° de Comprobante: <?php echo $reg->idcccliente; ?>
			</td>
		</tr>
	</table>
	<br>
	...
	<table border="0" align="center" width="300px">
		...
		<tr>
			<td>ULTIMO PAGO:</td>
			<td><p style="font-weight: bold;">$<?php echo $reg->pago; ?></p></td>
		</tr>
		<tr>
			<td>SALDO ACTUAL:</td>
...
*/
		...
		<tr>
			...
			<td align="right"><b>TOTAL EN VENTAS:</b></td>
