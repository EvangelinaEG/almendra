...
require_once "../modelos/Consultas.php";
  ...
  $totalc=number_format(round($regc->total_compra,2),2,',','');

  $rsptav = $consulta->totalventahoy();
  $regv=$rsptav->fetch_object();
  $totalv=number_format(round($regv->total_venta,2),2,',','');
 /* 
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
  <div class="box box-primary">
    <div class="box-header with-border">
     <button class="btn btn-primary" id="backup" onclick="backup(this)">Hacer Backup</button>
    </div>
    <div class="box-body">
