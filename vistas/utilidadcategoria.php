...
<button onclick="exportTableToExcel('tbllistado', 'Utilidad por Categoria')">Exportar a Excel</button>
</div>
    <thead>
      <th style="color:#000;font-weight: bold; background-color: #B1B3B4">id</th>
      <th style="color:#000;font-weight: bold; background-color: #B1B3B4" width="300">Categoria</th>
