...
<div class="box-header with-border">
  <h1 class="box-title">Stock de Productos </h1>
...
<button onclick="exportTableToExcel('tbllistado', 'Utilidad de Productos')">Exportar a Excel</button>
</div>
    <thead>
      ...
      <th style="color:#000;font-weight: bold; background-color: #B1B3B4">Stock</th>
      <th style="color:#000;font-weight: bold; background-color: #B1B3B4">Total</th>
...
require 'footer.php';
 ?>
 <script src="scripts/stockprods.js"></script>
