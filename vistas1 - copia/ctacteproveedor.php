...
<div class="box-header with-border">
  <h1 class="box-title">Cuenta Corriente de Proveedor <!-- <button class="btn btn-success" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button> --></h1>
...
<div class="panel-body" style="height: 100%;" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
       <h4>Registro de pagos de <strong id="idprove"></strong></h4>
       <hr>
