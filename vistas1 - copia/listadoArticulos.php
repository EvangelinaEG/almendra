...
<input type="checkbox" id="id" name="nombre[]" class="check" value="<?php echo $row['nombre']?>"><?php echo $row['nombre']?> <br>
<input type="hidden" name="idarticulo[]" value="<?php echo $row['idarticulo']; ?>"><br>


<?php if(isset($row['precioventa1'])){ ?>
<input type="hidden" name="precio1[]" value="<?php echo $row['precioventa1']; ?>">
<?php }if(isset($row['precioventa2'])){ ?>
<input type="hidden" name="precio2[]" value="<?php echo $row['precioventa2']; ?>">
<?php }if(isset($row['precioventa3'])){ ?>
<input type="hidden" name="precio3[]" value="<?php echo $row['precioventa3']; ?>">
<?php }if(isset($row['precioventa4'])){ ?>
<input type="hidden" name="precio4[]" value="<?php echo $row['precioventa4']; ?>">
<?php }?>
 <br/> 
  ...
  <input type="hidden" id="<?php echo $proveedor ?>" name="proveedor" value="<?php echo $proveedor ?>" >
              <button type="submit" name="enviar" id="boton" disabled="disabled" >Descargar</button>
              </form>
</div>
</div>
</div>
