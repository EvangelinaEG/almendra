...
precios = '<option  value="'+precio1+'" selected="selected"  >'+precio1+'</option><option value="'+precio2+'">'+precio2+'</option><option value="'+precio3+'">'+precio3+'</option><option value="'+precio4+'">'+precio4+'</option>';
        ...
        '<td><input type="text" onkeyup="modificarSubtotales()" class="form-control" name="precio_venta[]" id="precio_venta[]" list="misdatos"><datalist id="misdatos" name="misdatos">'+precios+'</datalist></td>'+
        
        '<td><input type="number" step="any" min="0" onkeyup="modificarSubtotales()" name="descuento[]" size="4" id="descuento[]" value="0"></td>'+
       '<td><input type="number" step="any" min="0" onkeyup="modificarSubtotales()" name="iva[]" id="iva[]" size="4" value="21"></td>'+
